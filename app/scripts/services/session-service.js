 ...
 */
angular.module('angularJsexamApp').service('sessionService', ['Data','sessionInfo', function(Data, sessionInfo)
{
    // AngularJS will instantiate a singleton by calling "new" on this function
    this.login = function(params, callback)
    {
    	var dataPromise = Data.setData('http://172.16.2.13:52273/user/login',
